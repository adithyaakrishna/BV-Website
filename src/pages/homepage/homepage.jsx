        ...
        <div  className="container">
            <div  className="row">
                ...
                <div  className="col-md-3 col-sm-3 col-xs-12 text-center mb">
                    ...
                    <div  className="images-text">
                        <h2><a href="#top">Register an NGO</a></h2>
                    </div>
                </div>
                <div  className="col-md-3 col-sm-3 col-xs-12 text-center">
                    <div  className="images">
                    ...
                    <div  className="images-text">
                        <h2><a href="#top">Report a Problem</a></h2>
                    </div>
                </div>
                <div  className="col-md-3 col-sm-3 col-xs-12 text-center">
                    <div  className="images">
            ...
            <div  className="row rowspace">
                        ...
                        <div  className="person-content">
                            <h2><a href="bvnews3"  className="title-white">BV – BRIDGING CHANGEMAKERS AND THE GOVERNMENT</a></h2>
                                        <ul  className="gb-list">
                                            ...
                                            <li>
                                                <a href="#top"><i  className="icon-heart" aria-hidden="true"></i>45</a>
                                            </li>
                                            <li>
                                                <a href="#top"><i  className="icon-eye" aria-hidden="true"></i>378</a>
                                            </li>
                                        </ul>
                ...
                <div  className="col-lg-6 col-md-6 col-sm-6 mb ">
                    <div  className="person-card">
                        ...
                        <div  className="person-content">
                            <h2><a href="bvnews3"  className="title-white">Bengaluru Veeraru stands to #topFightCOVID19</a></h2>
                                        <ul  className="gb-list">
                                            <li>
                                                <a href="#top"> May 10, 2020 </a>
                                            </li>
                                             
                                            <li>
                                                <a href="#top"><i  className="icon-heart" aria-hidden="true"></i>
                                                    45</a>
                                            </li>
                                            <li>
                                                <a href="#top"><i  className="icon-eye" aria-hidden="true"></i>
                                                    378</a>
                                            </li>
                                        </ul>
    ...
    <div  className="photo-container">
        <div  className="container-fluid photo">
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B42Cxx9FaJT/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b1.jpg" alt=""  className="img-small"/></a>            </div>
            <div  className="photo-link">                
                <a href="https://www.instagram.com/p/B_Fj3PSFMX6/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b2.png" alt=""  className="img-small"/></a>
            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B3MAmAqFKeE/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b3.jpg" alt=""  className="img-small"/></a>            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B3FKXewlZnJ/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b4.png" alt=""  className="img-small"/></a>            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B3HET8VltHA/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b5.png" alt=""  className="img-small"/></a>
            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B3HFtVdlpv4/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b6.png" alt=""  className="img-small"/></a>
            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B3HEufDl0d_/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b7.png" alt=""  className="img-small"/></a>            </div>
            <div  className="photo-link">
                <a href="https://www.instagram.com/p/B_aZ18HlbZX/" target="_blank"rel="noopener noreferrer"><img src="assets/images/b8.png" alt=""  className="img-small"/></a>            </div>
        </div>
    </div>
